...
<%
	...
	String allItemsApplying = request.getAttribute("allItemsApplying")==null?"":String.valueOf(request.getAttribute("allItemsApplying"));
	String hasItemsBusinessApplying =  request.getAttribute("hasItemsBusinessApplying")==null?"":String.valueOf(request.getAttribute("hasItemsBusinessApplying"));
...
<script>
	...
	var allItemsApplying = '<%=allItemsApplying%>';
	var hasItemsBusinessApplying = '<%=hasItemsBusinessApplying%>';
	...
	function stopBtnCss(){
		...
		if(""==stopStatus&&(process.indexOf("procurement")>-1||"over"==processStatus)&&Priv.vPriv["applypurch_stop"]){
			...
			FW.showBtnGroup("btn-group-process");
			$("#btn-process").hide();
			//禁用发送 撤回商务网、生成采购合同、退回
			FW.disableBtn("btn-submit");
			FW.disableBtn("btn-business");
			FW.disableLi("btn-nobusiness");
			FW.disableLi("btn-revert");
...
<script src="${basePath}js/purchase/zjw/purapply/purApplyForm.js?ver=${iVersion}"></script>
<script src="${basePath}js/purchase/zjw/purapply/purApplyList.js?ver=${iVersion}"></script>
<script src="${basePath}js/purchase/core/purapply/purApplyOper.js?ver=${iVersion}"></script>
<script src="${basePath}js/purchase/zjw/purapply/purApplyBtn.js?ver=${iVersion}"></script>
<script src="${basePath}js/purchase/zjw/purapply/purApplyProc.js?ver=${iVersion}"></script>
...
<body>
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
		<div class="btn-toolbar" id="toolbar1">
		    ...
		    <div class="btn-group btn-group-sm" id="btn-group">
		    	<%--代码控制 与btn-business同等权限 --%>
		    	<button type="button" class="btn btn-default dropdown-toggle"  id="btn-group-btn" data-toggle="dropdown">
			                            &nbsp;更多操作&nbsp;
			        <span class="caret"></span>
			    </button>
			    <ul class="dropdown-menu">
			        <li id="btn-revert"><a href="javascript:void(0)" >退回</a></li>
			        <li id="btn-nullifyStop"><a href="javascript:void(0)" >作废终止</a></li>
			        <li id="btn-stop"><a href="javascript:void(0)" >终止</a></li>
			        <li id="btn-nobusiness"><a href="javascript:void(0)" >撤回商务网</a></li>
			    </ul>
			</div>
		    <div class="btn-group btn-group-sm">
