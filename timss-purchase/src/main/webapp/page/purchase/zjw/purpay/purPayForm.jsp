...
<script src="${basePath}js/purchase/zjw/purpay/purPay.js?ver=${iVersion}"></script>
<script src="${basePath}js/purchase/zjw/purpay/purPayForm.js?ver=${iVersion}"></script>
<script src="${basePath}js/purchase/zjw/purpay/purPayList.js?ver=${iVersion}"></script>
<script src="${basePath}js/purchase/zjw/purpay/purPayBtn.js?ver=${iVersion}"></script>
