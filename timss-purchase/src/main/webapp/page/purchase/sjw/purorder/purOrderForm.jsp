...
<script>
	...
	$(document).ready(function() {
		...
		if ("" != processInstId) {
			$("#btn_print").show();
			var url = fileExportPath+"preview?__format=pdf&__report=report/TIMSS2_SJW_PO_001_pdf.rptdesign&siteid="+siteId+"&sheetid="+sheetId;
...
<script src="${basePath}js/purchase/sjw/purorder/purOrderList.js?ver=${iVersion}"></script>
