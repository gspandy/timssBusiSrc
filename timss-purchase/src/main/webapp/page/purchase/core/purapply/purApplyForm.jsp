...
<script>
	...
	$(document).ready(function() {
		...
		if ("" != processInstId) {
			...
			$("#btn_print").show();
			if("ITC" == siteId){
				reportUrl = fileExportPath+"preview?__format=pdf&__report=report/TIMSS2_ITC_PA_001.rptdesign&siteid="+siteId+"&sheetid="+sheetId+"&userid="+Priv.secUser.userId;
				FW.initPrintButton("#btn_print",reportUrl,"采购申请打印预览",null);
			}
		}
		initInnerTab();
		//修正按钮圆角样式
...
<script src="${basePath}js/purchase/core/purapply/purApplyForm.js?ver=${iVersion}"></script>
...
<script src="${basePath}js/purchase/core/purapply/purApplyBtn.js?ver=${iVersion}"></script>
<script src="${basePath}js/purchase/core/purapply/purApplyProc.js?ver=${iVersion}"></script>
