...
public class BusinessLeaderAudit extends DefOrderPayProcess {
    @Autowired
    ...
    @Autowired
    public SendPayEmailService sendPayEmailService;
    
    private static Logger LOG = Logger.getLogger(BusinessLeaderAudit.class);
    ...
    public void onComplete(TaskInfo taskInfo) {
        String procInstId = taskInfo.getProcessInstanceId();
        String businessId = workflowService.getVariable(procInstId, "businessId") == null ? "": String.valueOf(workflowService.getVariable(procInstId, "businessId"));
        String totalPayment = workflowService.getVariable(procInstId, "totalPayment") == null ? "": String.valueOf(workflowService.getVariable(procInstId, "totalPayment"));
        try {
            if("HIGH".equals( totalPayment )){
