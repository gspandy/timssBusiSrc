 ...
 * 部门部长审批
 */
public class DeptministerAudit extends TaskHandlerBase {
    @Autowired
    ...
    private Logger logger = Logger.getLogger( DeptministerAudit.class );

    public void init(TaskInfo taskInfo) {
        String id = (String) wfs.getVariable( taskInfo.getProcessInstanceId(), "businessId" );
        financeManagementApplySpecialService.updateFinanceManageApplyFlowStatus( id, "bmbzsp" );
    }
