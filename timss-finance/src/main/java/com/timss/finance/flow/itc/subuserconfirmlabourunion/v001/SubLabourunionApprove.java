package com.timss.finance.flow.itc.subuserconfirmlabourunion.v001;
...
public class SubLabourunionApprove extends TaskHandlerBase {
	...
	public void init(TaskInfo taskInfo) {
		...
		financeMainService.updateFinanceMainStatusByDid( "wait_labourunion_approve", did );
