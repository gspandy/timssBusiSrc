...
public class FgDeputyManager extends TaskHandlerBase {
	@Autowired
	...
	private static Logger logger = Logger.getLogger(FgDeputyManager.class);
	
	public void init(TaskInfo taskInfo) {
		
		String id = (String) wfs.getVariable( taskInfo.getProcessInstanceId(), "businessId" );
		financeManagementApplySpecialService.updateFinanceManageApplyFlowStatus(id, "fgldsp");
	 ...
	 public void onComplete(TaskInfo taskInfo) {
	        ...
	        logger.info( "完成分管副总审批工作流节点" + taskInfo.getTaskDefKey() + "对信息的更新" );
	    }
