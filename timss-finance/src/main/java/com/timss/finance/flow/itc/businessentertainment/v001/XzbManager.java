...
public class XzbManager extends TaskHandlerBase {
	@Autowired
	...
	private static Logger logger = Logger.getLogger(XzbManager.class);
	
	public void init(TaskInfo taskInfo) {
		String id = (String) wfs.getVariable( taskInfo.getProcessInstanceId(), "businessId" );
		financeManagementApplySpecialService.updateFinanceManageApplyFlowStatus(id, "xzbjlsp");
	}
	 ...
	 public void onComplete(TaskInfo taskInfo) {
             ...
             logger.info( "行政部经理审批工作流节点" + taskInfo.getTaskDefKey() + "对信息的更新" );
         }
