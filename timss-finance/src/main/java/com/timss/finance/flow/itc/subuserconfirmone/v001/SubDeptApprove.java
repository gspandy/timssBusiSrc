package com.timss.finance.flow.itc.subuserconfirmone.v001;
...
public class SubDeptApprove extends TaskHandlerBase {
	...
	public void init(TaskInfo taskInfo) {
		...
		financeMainService.updateFinanceMainStatusByDid( "wait_deptmgr_approve", did );
