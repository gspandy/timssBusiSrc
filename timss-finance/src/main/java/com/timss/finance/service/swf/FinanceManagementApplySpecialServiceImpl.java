package com.timss.finance.service.swf;
...
public class FinanceManagementApplySpecialServiceImpl implements FinanceManagementApplySpecialService {
    ...
    private Map<String, Object> startWorkflow(FinanceManagementApply financeManagementApply) {
        ...
        String workflowKey = "finance_" + infoScope.getSiteId().toLowerCase() + "_travelapply";
        ...
        String participantIds = financeManagementApply.getParticipantIds();
        //是否是部门正职
        isDept(map,participantIds);
        //是否是公司领导
        isLeader(map,participantIds);
        //出差天数
        ...
        //省内还是省外出差
        map.put( "applyType", financeManagementApply.getApplyType() );
        try {
        ...
        String orgId = infoScope.getOrgId();
        workflowService.setVariable( processInstId, "orgId", orgId );
     ...
     * @param map
     */
    private void isDept(Map<String, Object> map,String participantIds) {
     ...
     */
    private void isLeader(Map<String, Object> map,String participantIds) {
        //公司领导的id
    ...
    private void createOrUpdateHomepageDraft(FinanceManagementApply financeManagementApply, String processInstId) {
        ...
        // 更新待办草稿信息
        String url = "finance/fma/editFMAJsp.do?id=" + financeManagementApply.getId() + "&applyType=" + "travelapply";

        String status = financeManagementApply.getStatus();
        if(!"D".equals(status)){//对退回到第一个节点更新
        	String flowCode = financeManagementApply.getId();
        	String flowName = financeManagementApply.getDescription();//生物质站点的代办名称取申请事由
        	...
        	homepageworktask.setTypeName("出差申请");
        	homepageworktask.setName( financeManagementApply.getDescription() );
    ...
    public boolean endFlow(FlowVoidParamBean params) {
        ...
        workflowService.complete(taskId, null, null, null, message, false);
        return true;
    }
