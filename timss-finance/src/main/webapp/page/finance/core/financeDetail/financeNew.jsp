...
<html>
	<head>
		...
		<script type="text/javascript" src="${basePath}js/finance/core/financeNew.js?ver=${iVersion}"></script>
	...
	<body>
		...
		<div class="bbox toolbar-with-pager" id="toolbar_wrap">
			<div class="btn-toolbar" role="toolbar" id="btn_toolbar">
				...
				<div class="btn-group btn-group-sm">
					<button type="button" class="btn btn-default" id="flowInfoWithoutStatus"
						onclick="showFlowImg();">审批信息</button>
