...
<script src="${basePath}/js/finance/swf/fma/ftravelapply.js?ver=${iVersion}"></script>
<script>
	var pager={};
	var g = {users:{}};
	var id="${id}";
	var defKey="finance_"+ItcMvcService.getUser().siteId.toLowerCase()+"_travelapply";
	...
	$(document).ready(function() {
		...
		if(id && id != "" && id != null){
			...
			$("#btn_obsolete").hide();
			$("#fin-print").hide();
			$form.iForm("hide",["applyUsername","deptname"]);
		}
		//处理申请人和申请部门框
...
<body>
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    <div id="toolbar1" class="btn-toolbar ">
	        ...
	        <div class="btn-group btn-group-sm">
	            <button type="button" id="btn_handle" class="btn btn-default dropdown-toggle" data-toggle="dropdown" >办理
	            	<span class="caret"></span> <!-- 添加文字右边的"下箭头" -->
	            </button>
	            <ul class="dropdown-menu">
					<li><a onclick="newAbnormity()">办理考勤异常</a></li>
					<li id="btn_cancelHandle"><a onclick="cancelHandle()">无需办理</a></li>
					<li id="btn_cancelTravel"><a onclick="cancelTravel()">取消出差</a></li>
				</ul>
	        </div>
	         <div class="btn-group btn-group-sm">
