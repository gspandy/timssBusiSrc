...
<script src="${basePath}/js/finance/dpp/fma/common.js?ver=${iVersion}"></script>
...
<script src="${basePath}/js/finance/dpp/fma/workflow.js?ver=${iVersion}"></script>
<script src="${basePath}/js/finance/dpp/fma/ftravelapply.js?ver=${iVersion}"></script>
<script>
	var pager={};
	var g = {users:{}};
	var id="${id}";
	var defKey="finance_dpp_travelapply";
