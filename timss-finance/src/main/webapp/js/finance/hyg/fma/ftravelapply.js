...
function initPrint(data){
	//初始化打印按钮
		...
		var commonPath = "__report=report/TIMSS2_HYG_FIN_FMA_001.rptdesign&id=" + id
			+ "&siteid=HYG&proc_inst_id="+proc_inst_id+"&author="+loginUserId;
		//预览PDF并提供打印
