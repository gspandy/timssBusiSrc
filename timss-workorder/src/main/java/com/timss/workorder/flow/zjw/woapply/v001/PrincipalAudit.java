...
public class PrincipalAudit extends TaskHandlerBase {
    @Autowired
    ...
    private static Logger logger = Logger.getLogger(PrincipalAudit.class);
    ...
    public void init(TaskInfo taskInfo){
        ...
        //更新开工申请状态
        woUtilService.updateWoaplyStatus(woapplyId, WoapplyStatusUtil.PRINCIPAL_AUDIT);
        super.init( taskInfo );
    }
