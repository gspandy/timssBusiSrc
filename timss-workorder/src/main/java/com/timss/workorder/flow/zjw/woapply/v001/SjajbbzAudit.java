...
public class SjajbbzAudit extends TaskHandlerBase {
    @Autowired
    ...
    private static Logger logger = Logger.getLogger(SjajbbzAudit.class);
    ...
    public void init(TaskInfo taskInfo){
        ...
        //更新开工申请状态
        woUtilService.updateWoaplyStatus(woapplyId, WoapplyStatusUtil.SAFE_DEPARTLEADER_AUDIT);
        super.init( taskInfo );
    }
    ...
    public void onComplete(TaskInfo taskInfo){
        ...
        woUtilService.updateWoaplyStatus(woapplyId, WoapplyStatusUtil.FINISH);
