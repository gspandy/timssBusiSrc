...
public class SafeClearAudit  extends TaskHandlerBase{
	@Autowired
	...
	private static Logger logger = Logger.getLogger(SafeClearAudit.class);
	...
	public void init(TaskInfo taskInfo){
        ...
        logger.info( "SafeClearAudit init --- instantId = " + instantId + "-- businessId = " + woId );
        
        //更新工单状态
        woUtilService.updateWoStatus(woId, WoProcessStatusUtil.SAFE_CLEAR_AUDIT_STR);
        super.init( taskInfo );
	}
    ...
    public void onComplete(TaskInfo taskInfo){
        String instantId = taskInfo.getProcessInstanceId();
        String woId = workflowService.getVariable(taskInfo.getProcessInstanceId(), "businessId").toString();
        logger.info( "SafeClearAudit onComplete --- instantId = " + instantId + "-- businessId = " + woId );
    ...
    public void beforeRollback(TaskInfo taskInfo, String destTaskKey){
        String instantId = taskInfo.getProcessInstanceId();
        String woId = workflowService.getVariable(taskInfo.getProcessInstanceId(), "businessId").toString();
        logger.info( "SafeClearAudit beforeRollback --- instantId = " + instantId + "-- businessId = " + woId );
