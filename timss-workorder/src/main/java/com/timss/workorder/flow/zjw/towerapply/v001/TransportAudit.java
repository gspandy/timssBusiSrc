...
public class TransportAudit extends TaskHandlerBase {
    @Autowired
    ...
    private static Logger logger = Logger.getLogger(TransportAudit.class);
    ...
    public void init(TaskInfo taskInfo){
      ...
      //更新登塔申请状态
        woTowerApplyDao.updateTowerApplyStatus(towerApplyId, TowerApplyStatusUtil.TRANSPORT_AUDIT);
        super.init( taskInfo );
    }
