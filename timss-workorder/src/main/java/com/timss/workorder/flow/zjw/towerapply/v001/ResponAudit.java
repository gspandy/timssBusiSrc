...
public class ResponAudit extends TaskHandlerBase {
    @Autowired
    ...
    private static Logger logger = Logger.getLogger(ResponAudit.class);
    ...
    public void init(TaskInfo taskInfo){
      ...
      //更新登塔申请状态
        woTowerApplyDao.updateTowerApplyStatus(towerApplyId, TowerApplyStatusUtil.RESPON_AUDIT);
        super.init( taskInfo );
    }
