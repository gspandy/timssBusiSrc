...
public class DeputyAudit extends TaskHandlerBase {
    @Autowired
    ...
    private static Logger logger = Logger.getLogger(DeputyAudit.class);
    ...
    public void init(TaskInfo taskInfo){
      ...
      //更新登塔申请状态
        woTowerApplyDao.updateTowerApplyStatus(towerApplyId, TowerApplyStatusUtil.DEPUTY_AUDIT);
        super.init( taskInfo );
    }
