...
public class DelayDutyRestart  extends TaskHandlerBase{
	@Autowired
	...
	private static Logger logger = Logger.getLogger(DelayDutyRestart.class);
	...
	public void init(TaskInfo taskInfo){
        ...
        logger.info( "DelayDutyRestart init --- instantId = " + instantId + "-- businessId = " + woId );
        //更新工单状态
        woUtilService.updateWoStatus(woId, WoProcessStatusUtil.DELAY_DUTY_RESTART_STR);
        super.init( taskInfo );
	}
    ...
    public void onComplete(TaskInfo taskInfo){
        ...
        if(woIdObject != null){
            ...
            logger.info( "DelayDutyRestart onComplete --- instantId = " + instantId + "-- businessId = " + woId );
            //修改处理人
    ...
    public void beforeRollback(TaskInfo taskInfo, String destTaskKey){
        String instantId = taskInfo.getProcessInstanceId();
        String woId = workflowService.getVariable(taskInfo.getProcessInstanceId(), "businessId").toString();
        logger.info( "DelayDutyRestart beforeRollback --- instantId = " + instantId + "-- businessId = " + woId );
		//修改处理人
        UserInfoScope userInfoScope = itcMvcService.getUserInfoScopeDatas();
