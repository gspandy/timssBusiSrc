...
public class SjajbzzAudit extends TaskHandlerBase {
    @Autowired
    ...
    private static Logger logger = Logger.getLogger(SjajbzzAudit.class);
    ...
    public void init(TaskInfo taskInfo){
        ...
        //更新开工申请状态
        woUtilService.updateWoaplyStatus(woapplyId, WoapplyStatusUtil.SAFE_DEPARTMENT_AUDIT);
        super.init( taskInfo );
    }
