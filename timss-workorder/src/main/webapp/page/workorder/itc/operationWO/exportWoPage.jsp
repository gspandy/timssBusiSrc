...
<html>
  <head>
	...
	$(document).ready(function() {
		...
		urlReport = fileExportPath+"preview?__report=report/TIMSS2_WO_ITWOEXPORT_html.rptdesign&siteId="+siteId+
		...
		//导出
		var exportUrl = fileExportPath+"preview?__report=report/TIMSS2_WO_ITWOEXPORT.rptdesign&__format=xls&siteId="+siteId+
										"&beginTime="+beginTime+"&endTime="+endTime+"&enginnersIdstr="+enginnersIdstr+"&sdList="+
										sdList+"&scList="+scList; 
