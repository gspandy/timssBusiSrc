...
<script>
	...
	function initDataGrid(){
		 dataGrid = $("#maintainPlan_table").iDatagrid("init",{
	        ...
	        columns:[[ 
					{field:"maintainPlanCode",title:"编号",width:140,fixed:true,sortable:true},
	...
	function newMTP(){
	   ...
	   var urlPath = basePath+ "workorder/maintainPlan/openNewMTPPage.do?faultTypeParams="+encodeURIComponent(faultTypeParams);
	   var opts = {
	        id : "newMTP" + rand,
	        name : "新建维护计划",
	        url : urlPath,
