...
var fields = [
	...
	$(document).ready(function(){
		...
		$("#selectTimeForm").iForm("setVal",{"beginTime":beginTime,"endTime":endTime})
 		...
 		dataGrid = $("#woRequestStatistic_table").iDatagrid("init",{
	        ...
	        url: basePath + "/workorder/woStatis/woItManageKPIData.do",     
	        queryParams:{
	        	statisticType:"requstStatistic",  //requstStatistic、eventStatistic、
	        	begin:beginTime.getTime(),
	        	end:endTime.getTime()+24*60*60*1000
	        },
	        singleSelect:true,
	        columns:[[ 
					{field:"serLevel",title:"服务级别",width:60,fixed:true}, 
					{field:"eventType",title:"事件分类",width:110,fixed:true}, 
					{field:"sum",title:"请求总数",width:130,align:'center'}, 
	...
	function printStatisticList(){
		...
		var src = fileExportPath + "preview?__report=report/TIMSS2_WO_ITREQUEST_KPI.rptdesign&__format=pdf"+
