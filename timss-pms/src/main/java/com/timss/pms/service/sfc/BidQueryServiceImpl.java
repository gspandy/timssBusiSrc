...
import com.timss.pms.dao.SFCBidResultDao;
...
public class BidQueryServiceImpl implements BidQueryService {
	...
	@Autowired
	SFCBidResultDao sfcBidResultDao;
	...
	public Page<BidResultVo> queryBidResultListAndFilter(Page<BidResultVo> page,
		...
		List<BidResultVo> projects = sfcBidResultDao.queryBidResultListAndFilter(page);
	...
	public List<Map<String,String>> queryBidResultListByKeyWord(String kw) {
		...
		//根据站点和招标名称模糊搜索
		List<BidResultVo> bidResultVos = sfcBidResultDao.queryBidResultList(page);
