package com.timss.pms.flow.sjw.receipt.v001;
...
public class Zjlsp extends TaskHandlerBase{
	...
	public void onComplete(TaskInfo taskInfo) {
        ...
        if(map!=null){
    		...
    		Pay pay=new Pay();
    		pay.setId(Integer.valueOf( String.valueOf( map.get("id"))));
    		pay.setContractId(Integer.valueOf( String.valueOf( map.get("contractId"))));
    		pay.setPayplanId(Integer.valueOf( String.valueOf( map.get("payplanId"))));
    		//invoiceService.updateInvoice(invoices, pay);
    		pay=GetBeanFromBrowerUtil.getBeanFromBrower("插入的收款信息为", "businessData", Pay.class, itcMvcService);
