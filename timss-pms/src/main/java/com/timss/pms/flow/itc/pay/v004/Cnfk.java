package com.timss.pms.flow.itc.pay.v004;
 ...
 */
public class Cnfk extends TaskHandlerBase{
	@Autowired
	...
	private static final Logger LOGGER=Logger.getLogger(Cnfk.class);
	
	public void onComplete(TaskInfo taskInfo) {
		UserInfoScope userInfoScope=itcMvcService.getUserInfoScopeDatas();
		Pay pay=GetBeanFromBrowerUtil.getBeanFromBrower("插入的付款信息为", "businessData", Pay.class, itcMvcService);
		if(pay!=null){
		...
		LOGGER.info("完成项目付款工作流节点"+taskInfo.getTaskDefKey()+"对付款信息的更新");
	}
