...
public class DeptManagerApprove extends TaskHandlerBase{
	...
	private static final Logger LOGGER=Logger.getLogger(DeptManagerApprove.class);
	
	public void onComplete(TaskInfo taskInfo) {
		LOGGER.info("完成合同审批工作流节点"+taskInfo.getTaskDefKey()+"部门经理审批");
	}
}
