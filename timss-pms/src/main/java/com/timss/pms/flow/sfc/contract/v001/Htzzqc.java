...
public class Htzzqc extends TaskHandlerBase{
	@Autowired
	...
	private static final Logger LOGGER=Logger.getLogger(Htzzqc.class);
	...
	public void onComplete(TaskInfo taskInfo) {
		...
		if(contract!=null){
			contractService.updateContract(contract, null);
		}
