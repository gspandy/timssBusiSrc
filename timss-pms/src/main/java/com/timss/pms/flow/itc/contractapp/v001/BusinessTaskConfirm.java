...
/**
 * @ClassName: BusinessTaskConfirm
 * @company: gdyd
 * @Description:合同创建 提出申请节点类
 * @author:    gucw
 * @date:   2015-3-14 
 */
public class BusinessTaskConfirm extends TaskHandlerBase{
	@Autowired
	...
	private static final Logger LOGGER=Logger.getLogger(BusinessTaskConfirm.class);
	
	public void init(TaskInfo taskInfo){
		
	}
	public void onComplete(TaskInfo taskInfo) {
		LOGGER.info("完成合同审批工作流节点"+taskInfo.getTaskDefKey()+"商务专责确认");
	}
}
