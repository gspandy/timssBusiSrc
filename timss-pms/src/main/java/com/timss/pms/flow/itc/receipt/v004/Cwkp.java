...
//    		List<Invoice> invoices=JsonUtil.fromJsonStringToList(invoiceString, Invoice.class);
    		Pay pay=new Pay();
    		pay.setId(Integer.parseInt((String)map.get("id")));
    		pay.setContractId(Integer.parseInt((String)map.get("contractId")));
    		pay.setPayplanId(Integer.parseInt((String) map.get("payplanId")));
