package com.timss.pms.flow.itc.bidresult.v004;
 ...
 */
public class Zjlsh extends TaskHandlerBase{
	@Autowired
	...
	private static final Logger LOGGER=Logger.getLogger(Zjlsh.class);
