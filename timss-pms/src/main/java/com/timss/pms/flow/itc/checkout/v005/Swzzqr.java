package com.timss.pms.flow.itc.checkout.v005;
 ...
 */
public class Swzzqr extends TaskHandlerBase{
	@Autowired
	...
	private static final Logger LOGGER=Logger.getLogger(Swzzqr.class);
