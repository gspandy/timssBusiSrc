...
/**
 * @ClassName: DeputyManagerApprove
 * @company: gdyd
 * @Description:合同创建 提出申请节点类
 * @author:    gucw
 * @date:   2015-3-14 
 */
public class DeputyManagerApprove extends TaskHandlerBase{
	@Autowired
	...
	private static final Logger LOGGER=Logger.getLogger(DeputyManagerApprove.class);
	
	public void onComplete(TaskInfo taskInfo) {
		LOGGER.info("完成合同审批工作流节点"+taskInfo.getTaskDefKey()+"公司副总审批会签");
	}
}
