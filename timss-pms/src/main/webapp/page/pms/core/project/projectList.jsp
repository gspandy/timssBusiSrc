...
<link rel="stylesheet" type="text/css" href="${basePath}css/pms/common/common.css?ver=${iVersion}" media="all"></link>
	...
	$(document).ready(function() {
		...
		dataGrid = $("#test_grid1").iDatagrid("init",{
	        ...
	        columns:[[		
			 			...
			 			{
			 				field:'projectName',title:'名称',width:120,align:'left',sortable:true
			 			},
			 			{
			 			...
			 			{
			 				field:'paySum',title:'结算进度',width:180,align:'left',fixed:true,
			 				formatter:function(value,row,index){
			 					var percent=value/row["applyBudget"] *100;
			 			...
			 			{
			 				field:'endTime',title:'实施进度',width:150,align:'left',fixed:true,
			 				formatter: function(value,row,index){
			 					var result=$("<div></div>").progressSquareBar(row["milestoneVos"]);
			 					return result.html();
			 				}
