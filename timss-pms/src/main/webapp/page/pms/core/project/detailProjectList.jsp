...
<script>
	$(document).ready(function() {
		...
		dataGrid = $("#test_grid1").iDatagrid("init",{
	        ...
	        url: basePath + "pms/project/detailProjectListData.do",	//basePath为全局变量，自动获取的       
	        singleSelect:true,
	        ...
	        onDblClickRow:function(rowIndex, rowData){
	        	var id=rowData["id"];
	        	openTab( basePath + "pms/project/showDetailProject.do?id=" + id,"立项","pmsViewProjectTab"+id);
	        },
	        columns:[[		
			 			...
			 			{
			 				field:'property',title:'性质',width:48,align:'left',fixed:true,
			 		...
			 		//	{
			 		//		field:'bidResultNum',title:'招标数',width:70,align:'left',fixed:true
			 		//	},
			 			{
			 				field:'contractNum',title:'合同数',width:70,align:'right',fixed:true,
	         				sortable:true
			 			},
			 			{
			 				field:'contractSum',title:'合同总额(元)',width:105,align : 'right',fixed:true,
	         				sortable:true
			 			},
			 			{
			 				field:'paySum',title:'结算总额(元)',width:105,align : 'right',fixed:true,
	         				sortable:true
			 			},
			 			{
			 			...
			 			{
			 				field:'projectStatus',title:'状态',width:85,align:'left',fixed:true,
	         				sortable:true
			 			}
			 		]]
