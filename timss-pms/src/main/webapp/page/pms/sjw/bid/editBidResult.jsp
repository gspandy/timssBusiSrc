...
<script src="${basePath}js/pms/sjw/bid/bidResult.js?ver=${iVersion}"></script>
<script src="${basePath}js/pms/sjw/bid/editBidResult.js?ver=${iVersion}"></script>
<script>
var loginUserId = ItcMvcService.user.getUserId();
	var id=getUrlParam("id");
	var defKey="pms_sjw_bidresult";
