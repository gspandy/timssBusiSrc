...
<script src="${basePath}js/pms/itc/plan/editPlan.js?ver=${iVersion}"></script>
<script>
...
<body>
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    <div id="toolbar1" class="btn-toolbar ">
	        ...
	        <div class="btn-group btn-group-sm">
	         ...
	         <div class="btn-group btn-group-sm" >
	            <button type="button" class="btn btn-default pms-complex-privilege" onclick="changePlan(this);" id="pms-b-plan-change" >结转</button>
	        </div>
	        <div class="btn-group btn-group-sm ">
	...
	<div id="histInfoWrapper" grouptitle="历年信息" class="margin-group-bottom">
		<form id="histInfo" ></form>
	</div>
