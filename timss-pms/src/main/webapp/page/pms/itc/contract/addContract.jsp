...
<script src="${basePath}js/pms/itc/contract/addContract.js?ver=${iVersion}"></script>
<script>
...
<body>
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    <div id="toolbar1" class="btn-toolbar ">
	        ...
	        <div class="btn-group btn-group-sm">
	            <button type="button" class="btn btn-default" onclick="createContractCode();">生成合同编号</button>
	        </div>
	        <div class="btn-group btn-group-sm">
