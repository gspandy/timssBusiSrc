...
<script src="${basePath}js/pms/itc/project/editProject.js?ver=${iVersion}"></script>
...
<body>
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    <div id="toolbar1" class="btn-toolbar ">
	        ...
	        <div class="btn-group btn-group-sm "   >
	            <button type="button" class="btn btn-default pms-complex-privilege" id="pms-milestone-edit-actualtime" onclick="editMilestoneActualtime();">录入实施进度</button>
	        </div>
	        <div class="btn-group btn-group-sm"   >
	            <button type="button" class="btn btn-default  pms-complex-privilege" onclick="changeMilestone();" id="pms-milestone-change">变更里程碑信息</button>
	        </div>
	        <div class="btn-group btn-group-sm"   >
			...
			<div class="btn-group btn-group-sm" >
				<button type="button" class="btn btn-default dropdown-toggle pms-complex-privilege"  id="pms-project-complex-add"
					data-toggle="dropdown">新建&nbsp;<span class="caret"></span>
				</button>
				<ul class="dropdown-menu">
					<li ><a onclick="openBidTab();">新建招标</a>
					</li>
					<li ><a onclick="openContractTab();">新建合同</a>
					</li>
				</ul>
			</div>
			<div class="btn-group btn-group-sm " >
	            <button type="button" class="btn btn-default pms-complex-privilege" id="pms-b-br-add" onclick="openBidTab();">新建招标</button>
	        </div>
	        <div class="btn-group btn-group-sm " >
	            <button type="button" class="btn btn-default pms-complex-privilege" id="pms-b-contract-add" onclick="openContractTab();">新建合同</button>
	        </div>
			<div class="btn-group btn-group-sm">
