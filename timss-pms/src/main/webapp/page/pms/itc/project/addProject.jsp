...
<script src="${basePath}js/pms/itc/project/addProject.js?ver=${iVersion}"></script>
<script>
...
<body>
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    <div id="toolbar1" class="btn-toolbar ">
	        ...
	        <div class="btn-group btn-group-sm">
	            <button type="button" class="btn btn-default" onclick="createProjectCode();">生成项目编号</button>
	        </div>
	        <div class="btn-group btn-group-sm">
