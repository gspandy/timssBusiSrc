...
<script src="${basePath}js/pms/itc/bid/bidResult.js?ver=${iVersion}"></script>
<script src="${basePath}js/pms/itc/bid/editBidResult.js?ver=${iVersion}"></script>
<script>
...
<body>
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    <div id="toolbar1" class="btn-toolbar ">
	        ...
	        <div class="btn-group btn-group-sm " >
	            <button type="button" class="btn btn-default pms-complex-privilege" id="pms-b-contract-add"
	             onclick="addNewContract();">添加合同</button>
	        </div>
	        <div class="btn-group btn-group-sm " >
	            <button type="button" class="btn btn-default priv" privilege="pms-b-project-query"
	             onclick="openViewProject();" >查看所属项目</button>
	        </div>
	        <div class="btn-group btn-group-sm" >
	            <button type="button" class="btn btn-default"  id="pms-bidresult-print">打印</button>
	        </div>
	        <div class="btn-group btn-group-sm">
