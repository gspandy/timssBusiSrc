	        ...
	        columns : [ [
	         			/* {field:'ck',checkbox:true}, */
	         			{
	         				...
	         				'editor':{
	         					 "type" : "combobox",
	         					 "options" : {
	         					    "data" : FW.parseEnumData("PMS_CONTRACT_CATEGORY",_enum)
	         				     }
	         				},
	         				formatter:function(value){
	         					var list=FW.parseEnumData("PMS_CONTRACT_CATEGORY",_enum);
	         				...
	         				'editor':{
	         					 "type" : "combobox",
	         					 "options" : {
	         					    "data" : FW.parseEnumData("PMS_CONTRACT_BELONGTO",_enum)
	         				     }
	         				},
	         				formatter:function(value){
	         					var list=FW.parseEnumData("PMS_CONTRACT_BELONGTO",_enum);
	         					return getEnumValueByCode(list,value);
	         				}
