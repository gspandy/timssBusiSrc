...
<script src="${basePath}js/pms/sfc/checkout/editCheckout.js?ver=${iVersion}"></script>
<script>
	//获取合同id
...
<body>
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    <div id="toolbar1" class="btn-toolbar ">
	        ...
	        <div class="btn-group btn-group-sm">
	            <button type="button" class="btn btn-default priv" privilege="pms-b-contract-query" onclick="viewContract();">查看合同</button>
	        </div>
	        <div class="btn-group btn-group-sm">
