...
public class ReceiptToEipMobileTest extends TestUnit{
	@Autowired
	...
	public void test() {
         ...
         empb.setFlowNo("PR20141103004");
         empb.setProcessId("351801");
         RetContentBean eip = receiptToEipMobile.retrieveWorkflowFormDetails(empb);
	...
	public void testProcess() throws UnsupportedEncodingException{
        ...
        empb.setFlowID("next");
        empb.setFlowNo("PR20141106006");
        empb.setNextUser(nextUser);
        empb.setProcessId("368989");
        empb.setTaskKey("jlshjsfa");
        String value = URLDecoder.decode("testzhongwen测试中文", "UTF-8");
        empb.setOpinion( value );
        
        FlowEipUtil flowEipUtil=new FlowEipUtil(null, "368989", workflowService, itcMvcService,historyInfoService);
        ...
        emrb = receiptToEipMobile.processWorkflow(empb);
	...
	public void testProcessRollBack() throws UnsupportedEncodingException{
        ...
        empb.setOpinion( value );
        RetProcessBean emrb = receiptToEipMobile.processWorkflow(empb);
