...
public class CheckoutToEipMobileTest extends TestUnit{
	@Autowired
	...
	public void test() {
         ...
         empb.setFlowNo("PR20141024001");
         empb.setProcessId("323501");
         RetContentBean eip = checkoutToEipMobile.retrieveWorkflowFormDetails(empb);
	...
	public void testProcess() throws UnsupportedEncodingException{
        ...
        empb.setFlowID("next");
        empb.setFlowNo("PR20141106004");
        empb.setNextUser(nextUser);
        empb.setProcessId("368943");
        empb.setTaskKey("jlshjsfa");
        String value = URLDecoder.decode("testzhongwen测试中文", "UTF-8");
        empb.setOpinion( value );
        
        FlowEipUtil flowEipUtil=new FlowEipUtil(null, "368943", workflowService, itcMvcService,historyInfoService);
        ...
        emrb = checkoutToEipMobile.processWorkflow(empb);
	...
	public void testProcessRollBack() throws UnsupportedEncodingException{
        ...
        empb.setOpinion( value );
        RetProcessBean emrb = checkoutToEipMobile.processWorkflow(empb);
