...
public class MaintainPlan  extends ItcMvcBean {
  
	private static final long serialVersionUID = 4335684793757684448L;
	/** id */
	private int id; 
	@AutoGen(value = "WO_MTP_CODE",requireType = GenerationType.REQUIRED_NEW)
...
//	private String equipSiteCode;
	private String equipNameCode;
//	private String equipSite;//设备位置
...
//	}
	...
	public String toString() {
		return "MaintainPlan [id=" + id + ", maintainPlanCode="
				+ maintainPlanCode + ", description=" + description
				+ ", specialtyId=" + specialtyId + ", faultTypeId="
				+ faultTypeId + ", faultTypeName=" + faultTypeName
				+ ", equipNameCode=" + equipNameCode + ", equipName="
				+ equipName + ", equipId=" + equipId + ", principal="
				+ principal + ", principalName=" + principalName
				+ ", workTeam=" + workTeam + ", workTeamName=" + workTeamName
				+ ", maintainPlanCycle=" + maintainPlanCycle
				+ ", currStartTime=" + currStartTime + ", alertTime="
				+ alertTime + ", maintainPlanFrom=" + maintainPlanFrom
				+ ", remarks=" + remarks + ", jobPlanId=" + jobPlanId
				+ ", parentMTPId=" + parentMTPId + ", parentMTPCode="
				+ parentMTPCode + ", isHandler=" + isHandler + ", preWO="
				+ preWO + ", newToDoTime=" + newToDoTime + ", isAutoGenerWo="
				+ isAutoGenerWo + ", hasAlertTodo=" + hasAlertTodo + ", yxbz="
				+ yxbz + "]";
	}
