...
public class SwLedgerAppBean extends ItcMvcBean {
	private static final long serialVersionUID = -1925342436768167793L;
	/** 应用id
	 * 
	 * */
	@AutoGen("AST_SW_APP_SEQ")
	@EntityID
	 ...
	 * 
	 * */
	private String isMiddleware;
	/** 虚拟化迁移
	 * 
	 * */
	private String virtualMigration;
	/** 本地磁盘使用
	 * 
	 * */
	private String localDiskUsage;
	/** NAS使用
	 * 
	 * */
	private String nasUsage;
	/** SAN-LUN使用
	 * 
	 * */
	private String sanLunUsage;
	/** 备注
	 * 
	 * */
	private String remarks;
	
	private SwLedgerBean swl;//所属的软件台账
	private HwLedgerDeviceBean hwlDevice;//部署所在的硬件设备
	...
	public String getSoftwareSn() {
		return softwareSn;
	}
	public void setSoftwareSn(String softwareSn) {
		this.softwareSn = softwareSn;
	}
	...
	public String getVirtualMigration() {
		return virtualMigration;
	}
	public void setVirtualMigration(String virtualMigration) {
		this.virtualMigration = virtualMigration;
	}
	public String getLocalDiskUsage() {
		return localDiskUsage;
	}
	public void setLocalDiskUsage(String localDiskUsage) {
		this.localDiskUsage = localDiskUsage;
	}
	public String getNasUsage() {
		return nasUsage;
	}
	public void setNasUsage(String nasUsage) {
		this.nasUsage = nasUsage;
	}
	public String getSanLunUsage() {
		return sanLunUsage;
	}
	public void setSanLunUsage(String sanLunUsage) {
		this.sanLunUsage = sanLunUsage;
	}
	...
	public SwLedgerBean getSwl() {
		return swl;
	}
	public void setSwl(SwLedgerBean swl) {
		this.swl = swl;
	}
	public HwLedgerDeviceBean getHwlDevice() {
		return hwlDevice;
	}
	public void setHwlDevice(HwLedgerDeviceBean hwlDevice) {
		this.hwlDevice = hwlDevice;
	}
