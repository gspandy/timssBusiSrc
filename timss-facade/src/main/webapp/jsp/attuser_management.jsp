...
<script>
	...
	function loadListPage(){
		$("#user_div").attr("src","${basePath}${resBase}jsp/attuser_list.jsp?filter=" + filter + "&filterType=" + filterType);
	}
		...
		$('#org_tree').tree({
			...
			onClick: function(node){
				...
				if(filterType=="org"){
					...
					$("#user_div").attr("src","${basePath}attuser?method=getuser&mode=edit&uid=" + filter);
				}
			}
		});
	});
