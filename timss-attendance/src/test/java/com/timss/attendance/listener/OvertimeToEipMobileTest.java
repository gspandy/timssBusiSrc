...
public class OvertimeToEipMobileTest extends TestUnit {
    @Autowired
    private OvertimeToEipMobile overtimeToEipMobile;
    ...
    public void testRetrieveWorkflowFormDetails() {
            ...
            empb.setFlowNo("AO20150115003");
            empb.setProcessId("466426");
            RetContentBean eip = overtimeToEipMobile.retrieveWorkflowFormDetails(empb);
    ...
    public void testprocessWorkflowAgree() throws UnsupportedEncodingException {
            ...
            empb.setFlowID("next");
            empb.setFlowNo("AO20141016002");
            empb.setNextUser(nextUser);
            empb.setProcessId("298201");
            String value = URLDecoder.decode("testzhongwen测试中文", "UTF-8");
            empb.setOpinion( value );
            RetProcessBean emrb = overtimeToEipMobile.processWorkflow(empb);
