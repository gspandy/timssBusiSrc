...
var modelFlag = false;
	...
	$(document).ready(function() {
		...
		dataGrid = $("#contentTb").iDatagrid("init",{
	        ...
	        singleSelect :true,
	        fitColumns:true,
	        url: basePath + "attendance/leave/queryLeaveBySiteId.do",	//basePath为全局变量，自动获取的       
	        "columns":[[
				...
				{field:'leaveCategory',title:'请假类别',width:100,fixed:true, sortable: true},
	        ...
	        onDblClickRow : function( rowIndex, rowData ){
		    	...
		    	addTabWithTree( "updateLeave"+rowData.id, "请假申请", url,"attendance", "contentTb" );
		    }
		...
		$("#btn_add,#addBtn").click(function(){
			...
			addTabWithTree( "addLeave", "请假申请", url,"attendance", "contentTb");
		});
