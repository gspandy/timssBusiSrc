	...
	$(document).ready(function() {
		...
		$("#btn_advlocal").click(function() {
			if($(this).hasClass("active")){
				...
				$("#contentTb").ITCUI_GridSearch("init",{"remoteSearch":true,noSearchColumns:{19:true},"onParseArgs":function(arg){
...
<body style="height: 100%;min-width:1395px" class="bbox list-page">
