...
function monthReport(){
	...
	if( month==0 ){
		...
		var url = fileExportPath + "preview?__report=report/"+template+".rptdesign&__format=pdf&roleFlag="+roleFlag
	...
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    ...
	    <div id="toolbar" class="btn-toolbar ">
	        ...
	        <div class="atd_btn_pri atd_stat_count btn-group btn-group-sm">
	           <button type="button" class="btn btn-default" id="countBtn">年度报表</button>
	        </div>
	...
	<div style="clear:both"></div>
	 <div id="advSearchBar" style="height: 35px;margin-top: 6px;display: none;" class="bbox">
	    ...
	    <div class="atd_btn_pri atd_stat_count btn-group btn-group-sm fl" style="margin-left:8px">
	        <button type="button" class="btn btn-default" id="monthBtn">月度报表</button>
	    </div>
	</div>
