 ...
 * 分管领导
 */
public class LeaveFgldHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveFgldHandler.class );
    /**
     * 回滚前
     */
    @Override
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.SWF_FGLD );
