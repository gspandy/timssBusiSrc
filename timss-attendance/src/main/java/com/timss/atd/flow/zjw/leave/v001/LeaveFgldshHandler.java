 ...
 * @version: 1.0
 */
public class LeaveFgldshHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveFgldshHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " 分管领导 beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.FGLDSH );
