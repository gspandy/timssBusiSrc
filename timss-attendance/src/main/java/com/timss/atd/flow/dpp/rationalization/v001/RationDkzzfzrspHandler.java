...
public class RationDkzzfzrspHandler extends TaskHandlerBase{

	
    
    final String handlerName="DPP RationDkzzfzrspHandler";
    Logger log = LoggerFactory.getLogger( RationDkzzfzrspHandler.class );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        List<String> uIdList = (List<String>) workflowService.getVariable(
			...
			wfUtil.updateRationAuditStatusByTask(taskInfo, ProcessStatusUtil.DPP_RATION_DKZYFZRSP, userInfo.getSecureUser(),userId);
