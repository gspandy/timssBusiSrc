 ...
 * 人力党群部审核
 */
public class LeaveRldqHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveRldqHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " 人力党群部审核 beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.SWF_RLDQ );
