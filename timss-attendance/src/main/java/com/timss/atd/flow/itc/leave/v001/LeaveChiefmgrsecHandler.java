 ...
 * @version: 1.0
 */
public class LeaveChiefmgrsecHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveChiefmgrsecHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " LeaveChiefMgrSecHandler beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        logger.info( "LeaveChiefMgrSecHandler init" );
        ...
        parmas.put( "status", ProcessStatusUtil.ZJLSP );
    ...
    public void onComplete(TaskInfo taskInfo) {
        logger.info( "LeaveChiefMgrSecHandler onComplete" );
