 ...
 * 文秘专责审批
 */
public class WmzzAudit extends TaskHandlerBase{
	@Autowired
	...
	private static Logger logger = Logger.getLogger(WmzzAudit.class);
	/**
	 * 初始化
	 */
	@Override
	public void init(TaskInfo taskInfo){
        ...
        logger.info( "文秘专责审批 init --- instantId = " + instantId + "-- saId = " + saId );
        SealApplyBean sab = new SealApplyBean();
        sab.setSaId(saId);
        sab.setStatus("wmzz_audit");
