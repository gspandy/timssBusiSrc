 ...
 * @version: 1.0
 */
public class LeaveGhshHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveGhshHandler.class );
    /**
     * 回滚前
     */
    @Override
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.GHSH );
