 ...
 * @version: 1.0
 */
public class LeaveFgfzbHandler extends TaskHandlerBase {
    
    private Logger log = Logger.getLogger( LeaveFgfzbHandler.class );
    ...
    final String handlerName="HYG LeaveFgfzbHandler";
    ...
    public void onShowAudit(String taskId) {
    	...
    	String instanceId = taskInfo.getProcessInstanceId();
    	Double day = Double.parseDouble(workflowService.getVariable(instanceId, "leaveDays").toString());
    	workflowService.setVariable(instanceId, "sptype", day>3?"Y":"N");
