 ...
 * @version: 1.0
 */
public class LeaveRsshHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveRsshHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " 人事备案 beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.RSSH );
