 ...
 * @version: 1.0
 */
public class LeaveBzshHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveBzshHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " 班长审核 beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.BZSH );
