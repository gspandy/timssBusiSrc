...
public class RationSqrqdHandler extends TaskHandlerBase{

	
    
    final String handlerName="DPP RationSqrqdHandler";
    Logger log = LoggerFactory.getLogger( RationSqrqdHandler.class );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        try {
			...
			wfUtil.updateRationAuditStatusByTask(taskInfo, ProcessStatusUtil.DPP_RATION_SQRDR, userInfo.getSecureUser(),userId);
