 ...
 * 请假申请--部门审批
 */
public class LeaveFgldspHandler extends TaskHandlerBase {
    Logger log = LoggerFactory.getLogger( LeaveFgldspHandler.class );
    @Autowired
    ...
    final String handlerName="DPP LeaveFgldspHandler";
    ...
    public void init(TaskInfo taskInfo) {
        ...
        wfUtil.updateLeaveAuditStatusByTask(taskInfo, ProcessStatusUtil.DPP_LEAVE_FGLDSP);
        super.init( taskInfo );
    }
