 ...
 * 提交考勤异常申请
 */
public class AbnormityBmspHandler extends TaskHandlerBase {
    @Autowired
    ...
    Logger logger = LoggerFactory.getLogger( AbnormityBmspHandler.class );
    final String handlerName="DPP AbnormityBmspHandler";
    ...
    public void init(TaskInfo taskInfo) {
    	...
    	wfUtil.updateAbnormityAuditStatusByTask(taskInfo, ProcessStatusUtil.DPP_ABNORMITY_BMYJ);
        super.init( taskInfo );
    }
