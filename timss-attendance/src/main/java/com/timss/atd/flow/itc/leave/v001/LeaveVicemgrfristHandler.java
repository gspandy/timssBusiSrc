 ...
 * @version: 1.0
 */
public class LeaveVicemgrfristHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveVicemgrfristHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " LeaveViceMgrFristHandler beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        logger.info( "LeaveViceMgrFristHandler init" );
