 ...
 * @version: 1.0
 */
public class LeaveZjlshHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveZjlshHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " 总经理审批 beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.ZJLSH );
