...
public class RationPswyhpjHandler extends TaskHandlerBase{

	
    
    final String handlerName="DPP RationPswyhpjHandler";
    Logger log = LoggerFactory.getLogger( RationPswyhpjHandler.class );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        List<String> uIdList = (List<String>) workflowService.getVariable(
			...
			wfUtil.updateRationAuditStatusByTask(taskInfo, ProcessStatusUtil.DPP_RATION_PSWYHPJ, userInfo.getSecureUser(),userId);
