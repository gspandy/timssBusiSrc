 ...
 * @description: {desc}
 * @company: gdyd
 * @className: LeaveZzhdHandler.java
 * @author: yyn
 * @createDate: 2016.1.11
 * @updateUser: yyn
 * @version: 1.0
 */
public class LeaveZzhdHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveZzhdHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " 专责核定假期 beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.ZZHD );
