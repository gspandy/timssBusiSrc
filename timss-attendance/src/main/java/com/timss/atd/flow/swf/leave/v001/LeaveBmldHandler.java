 ...
 * 部门领导审批
 */
public class LeaveBmldHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveBmldHandler.class );
    /**
     * 回滚前
     */
    @Override
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.SWF_BMLD );
