 ...
 * @version:1.0
 */
public class GeneralManagerAudit extends TaskHandlerBase{
	@Autowired
	...
	private static Logger logger = Logger.getLogger(GeneralManagerAudit.class);
	/**
	 * 初始化
	 */
	@Override
	public void init(TaskInfo taskInfo){
        ...
        logger.info( "GeneralManagerAudit init --- instantId = " + instantId + "-- saId = " + saId );
        SealApplyBean sab = new SealApplyBean();
        sab.setSaId(saId);
        sab.setStatus("general_manager_audit");
