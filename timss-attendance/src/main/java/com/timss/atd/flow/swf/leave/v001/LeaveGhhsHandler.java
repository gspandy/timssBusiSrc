 ...
 * @title: 工会核实
 */
public class LeaveGhhsHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveGhhsHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " 工会审核 beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        parmas.put( "status", ProcessStatusUtil.SWF_GHHS );
