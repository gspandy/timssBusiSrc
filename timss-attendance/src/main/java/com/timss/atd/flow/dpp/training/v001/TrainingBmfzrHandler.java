 ...
 * 部门负责人审批
 */
public class TrainingBmfzrHandler extends TaskHandlerBase {
	Logger logger = LoggerFactory.getLogger( TrainingPxfbzrHandler.class );
    @Autowired
    private AtdWorkFlowUtil wfUtil;
    final String handlerName="DPP TrainingBmfzrHandler";
    @Autowired
    ...
    public void init(TaskInfo taskInfo) {
        ...
        try {
			wfUtil.updateTrainingAuditStatusByTask(taskInfo, ProcessStatusUtil.DPP_TRAINING_BMFZR, userInfo.getSecureUser());
			super.init( taskInfo );
		} catch (Exception e) {
