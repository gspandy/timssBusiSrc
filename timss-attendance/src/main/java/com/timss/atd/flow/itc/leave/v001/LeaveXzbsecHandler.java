 ...
 * @description: {desc}
 * @company: gdyd
 * @className: LeaveXzbSecHandler.java
 * @author: fengzt
 * @createDate: 2014年9月1日
 * @updateUser: fengzt
 * @version: 1.0
 */
public class LeaveXzbsecHandler extends TaskHandlerBase {
    ...
    Logger logger = LoggerFactory.getLogger( LeaveXzbsecHandler.class );
    /**
     * 回滚前
     */
    @Override
    public void beforeRollback(TaskInfo sourceTaskInfo, String destTaskKey) {
        logger.info( " LeaveXzbSecHandler beforeRollback" );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        logger.info( "LeaveXzbSecHandler init" );
...
//        String instanceName = taskList.get( 0 ).getName();
    ...
    public void onComplete(TaskInfo taskInfo) {
        logger.info( "LeaveXzbSecHandler onComplete" );
