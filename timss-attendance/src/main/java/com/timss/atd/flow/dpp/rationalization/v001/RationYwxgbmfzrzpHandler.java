...
public class RationYwxgbmfzrzpHandler extends TaskHandlerBase{

	
    
    final String handlerName="DPP RationYwxgbmfzrzpHandler";
    Logger log = LoggerFactory.getLogger( RationYwxgbmfzrzpHandler.class );
    ...
    public void init(TaskInfo taskInfo) {
        ...
        List<String> uIdList = (List<String>) workflowService.getVariable(
			...
			wfUtil.updateRationAuditStatusByTask(taskInfo, ProcessStatusUtil.DPP_RATION_YWBMFZRZP, userInfo.getSecureUser(),userId);
