...
public class DateFormatUtil {
     ...
     * @return:boolean
     */
    public static boolean compareDateNoEqual( Date dateBig , Date dateSm ){
        long bigTime = dateBig.getTime();
    ...
    public static Date getYearLast(){  
        ...
        Date currentLast = getCurrYearLast( year );
        String dateStr = formatDate( currentLast, "yyyy-MM-dd") + " 23:59";
     ...
     * @return Date 
     */  
    public static Date getYearFrist( ){  
        Calendar calendar = Calendar.getInstance();  
        int yearNum = calendar.get( Calendar.YEAR );
        Date currentFrist = getCurrYearFirst( yearNum );
        String dateStr = formatDate( currentFrist, "yyyy-MM-dd") + " 00:00";
        return parseDate( dateStr, "yyyy-MM-dd hh:mm" );  
    }  
    
    /**
     * 
     * @description:Date to Calender
     * @author: fengzt
     ...
     * @return Date 
     */  
    public static Date getYearFirstMMDD(int year){  
        Date currentFrist = getCurrYearFirst( year );
        String dateStr = formatDate( currentFrist, "yyyy-MM-dd") + " 00:00";
        return parseDate( dateStr, "yyyy-MM-dd hh:mm" );  
    }  
     ...
     * @return Date 
     */  
    public static Date getYearLastMMDD(int year){  
        Date currentLast = getCurrYearLast( year );
        String dateStr = formatDate( currentLast, "yyyy-MM-dd") + " 23:59";
        return parseDate( dateStr, "yyyy-MM-dd hh:mm" );  
    }  
    ...
    public static Date getMonthFirst( int year, int month ){  
        ...
        String dateStr = formatDate( strDateFrom, "yyyy-MM-dd") + " 00:00";
        return parseDate( dateStr, "yyyy-MM-dd hh:mm" ); 
    }  
    ...
    public static Date getMonthEnd( int year, int month ){  
        ...
        Date strDateFrom = calendar.getTime();
        String dateStr = formatDate( strDateFrom, "yyyy-MM-dd") + " 23:59";
        return parseDate( dateStr, "yyyy-MM-dd hh:mm" ); 
    }  
    ...
    public static void main(String[] args) {
        ...
        System.out.println( fromDateToCalendar( new Date() ).get( Calendar.YEAR ));
        System.out.println( getYearFirstMMDD( 2014 ));
        System.out.println(getYearLastMMDD( 2014 ));
        System.out.println( getCurrYearFirst( 2013 ));
        System.out.println( getCurrYearLast( 2013 ));
        
        String str = "2013-12-31";
        System.out.println( str.substring( 0, 4 ) + "######---------");
        System.out.println( str.indexOf( "-01-01" ) + "######---------");
        System.out.println( str.indexOf( "-12-31" ) + "######---------");
        ...
        System.out.println( DateFormatUtil.addDate( getFormatDate( getCurrentDate(), "yyyy-MM-dd" ) , "y", -3 ));
        System.out.println( DateFormatUtil.addDate( getFormatDate( getCurrentDate(), "yyyy-MM-dd" ) , "y", -15 ).getTime() );
        
        String dateStr = "2014-07-17 12:00";
        System.out.println( parseDate( dateStr,  "yyyy-MM-dd HH:mm" ) );
        System.out.println( parseDate( dateStr,  "yyyy-MM-dd hh:mm" ) );
        ...
        System.out.println( getMonthFirst( 2015, 3 ) );
        System.out.println( getMonthEnd( 2015, 3 ) );
