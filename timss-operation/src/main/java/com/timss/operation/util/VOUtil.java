...
public class VOUtil {
    ...
    public static List<HashMap<String, Object>> fromJsonToHashMapList( String dataJson ){
    	return JSON.parseObject(dataJson, new TypeReference<List<HashMap<String,Object>>>(){});
    }
