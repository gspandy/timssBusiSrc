...
<script>
	...
	$(document).ready(function() {
		...
		dataGrid = $("#contentTb").iDatagrid("init",{
	        ...
	        singleSelect :true,
	        url: basePath + "operation/dept/queryAllDeptList.do",	//basePath为全局变量，自动获取的       
	        "columns":[[
				{field:'deptId',title:'工种编码',width:180,fixed:true,hidden:true},
				{field:'name',title:'名称',width:180,fixed:true},
				{field:'updateBy',title:'更新人',width:20,hidden:true},
				{field:'siteId',title:'站点',width:20,hidden: true},
				{field:'isActive',title:'是否可用',width:150,
	        ...
	        onDblClickRow : function( rowIndex, rowData ){
		    	var url = "${basePath}page/operation/core/schedule/Dept-updateDept.jsp?id="+rowData.deptId;
		    	//FW.set("operationRowData",rowData);
		    	addTabWithTree( "deptDetail"+rowData.deptId, "工种", url,"opmm", "contentTb" );
		    }

	    });
		
		$("#btn_add").click(function(){
			var url ="${basePath}page/operation/core/schedule/Dept-insertDept.jsp";
			addTabWithTree( "addDept", "工种", url,"opmm", "contentTb");
		});
