...
<script>
	...
	$(document).ready(function() {
		...
		dataGrid = $("#contentTb").iDatagrid("init",{
	        ...
	        singleSelect :true,
	        url: basePath + "operation/jobs/queryAllJobsList.do",	//basePath为全局变量，自动获取的       
	        "columns":[[
				{field:'id',title:'ID',fixed:true,hidden:true},
				{field:'name',title:'名称'},
				{field:'stationId',title:'工种'},
				{field:'sortType',title:'排序',width:60,fixed:true},
	        ...
	        onDblClickRow : function( rowIndex, rowData ){
	        	var url = basePath + "operation/jobs/updateJobsForm.do?id=" + rowData.id;
		    	//var url = "${basePath}page/operation/core/operationlog/Jobs-updateJobs.jsp?id="+rowData.id;
		    	//FW.set("operationRowData",rowData);
		    	addTabWithTree( "jobsDetail"+rowData.id, "岗位", url,"opmm", "contentTb" );
		    }

	    });
		
		$("#btn_add").click(function(){
			var url ="${basePath}page/operation/core/operationlog/Jobs-insertJobs.jsp";
			addTabWithTree( "addJobs", "岗位", url,"opmm", "contentTb");
		});
