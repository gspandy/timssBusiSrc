var PageList={
		...
		toShow:function(data){
			...
			if(PageList.objs.datagrid.detailPage.openTab){
				addTabWithTree(PageList.objs.datagrid.detailPage.idPrefix+"_"+dataId, 
								PageList.objs.datagrid.detailPage.namePrefix,url,null,PageList.objs.datagrid.id);
			}else{
				FW.navigate(url);
			}
		},
		...
		toCreate:function(){
			...
			if(PageList.objs.datagrid.detailPage.openTab){
				addTabWithTree("create_"+PageList.objs.datagrid.detailPage.idPrefix, 
								PageList.objs.datagrid.detailPage.namePrefix,url,null,PageList.objs.datagrid.id);
			}else{
				FW.navigate(url);
			}
