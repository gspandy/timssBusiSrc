package com.timss.ptw.flow.sjc.dh1lic.v001;
...
public class PtwLicExec extends TaskHandlerBase {
    @Autowired
    ...
    public void onComplete(TaskInfo taskInfo) {
        ...
        try {
            ...
            ptwFireInfoService.updatePtwFireLicWpExec( Integer.parseInt( wtId ), userId, userName, new Date() );
        } catch (Exception e) {
