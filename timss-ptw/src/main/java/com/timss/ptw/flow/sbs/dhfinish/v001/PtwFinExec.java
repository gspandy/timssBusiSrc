package com.timss.ptw.flow.sbs.dhfinish.v001;
...
public class PtwFinExec extends TaskHandlerBase {
    @Autowired
    ...
    public void onComplete(TaskInfo taskInfo) {
        ...
        try {
            ...
            ptwFireInfoService.updatePtwFireFinWpExec( Integer.parseInt( wtId ), userId, userName, new Date() );
        } catch (Exception e) {
