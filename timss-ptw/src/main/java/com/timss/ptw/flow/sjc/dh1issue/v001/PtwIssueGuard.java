package com.timss.ptw.flow.sjc.dh1issue.v001;
...
public class PtwIssueGuard extends TaskHandlerBase {
    @Autowired
    ...
    public void onComplete(TaskInfo taskInfo) {
        ...
        try {
            ...
            ptwFireInfoService.updatePtwFireIssueGuard( Integer.parseInt( wtId ), userId, userName, new Date() );
        } catch (Exception e) {
