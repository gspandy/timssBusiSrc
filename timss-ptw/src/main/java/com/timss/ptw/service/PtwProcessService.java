 ...
 * @version: 1.0
 */
public interface PtwProcessService {
    /**
     * 根据工作票编号查询
     * @description:
     * @author: 周保康
     ...
     * @return:
     */
    PtwProcess queryPtwProcessByWtIdAndStatus(int wtId,int wtStatus);
     ...
     * @return:
     */
    String startNewProcess(PtwInfo ptwInfo,UserInfoScope userInfoScope,String processName,String processCode) throws Exception;
