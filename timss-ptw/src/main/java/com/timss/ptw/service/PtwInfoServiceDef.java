 ...
 * @version: 1.0
 */
public interface PtwInfoServiceDef {
    /**
     * 
    ...
    */
     ...
     * @createDate: 2014-6-27
     * @param ptwInfo
     * @param hasProcess 是否走工单流程
     * @param isProcess 是否启动待办
     * @return:更新的行数
     */
    String updatePtwIssueInfo(PtwInfo ptwInfo,String password,Date modifyDate,boolean isEdit,String ptwTypeCode,String safeItems,PtwFireInfo ptwFireInfo, boolean hasProcess, boolean isProcess)  throws Exception;
     ...
     * @return:
     */
    String updatePtwFinInfo(PtwInfo ptwInfo,String password,Date modifyDate, boolean hasProcess, boolean isProcess) throws Exception;
     ...
     * @param modifyDate
     * @param safeItems
     * @param hasWorkOrder 是否走工单流程
     * @param isProcess 是否启动待办
     * @return:
     */
    int updatePtwEndInfo(PtwInfo ptwInfo,String password,Date modifyDate,String safeItems, boolean hasWorkOrder, boolean isProcess);
     ...
     * @return:
     */
    int updatePtwCancelInfo(PtwInfo ptwInfo,String password,Date modifyDate, boolean hasWorkOrder, boolean isProcess);
     ...
     * @return
     */
    int deletePtwInfo(int id, boolean hasWorkOrder, boolean isProcess);
    ...
    int updatePtwAttachInfo(PtwInfo ptwInfo, PtwFireInfo ptwFireInfo);
}
