...
<script type="text/javascript" src="${basePath}js/ptw/sbs/PtwUtil.js?ver=${iVersion}"></script>
...
<script type="text/javascript" src="${basePath}js/ptw/sbs/ptwBase.js?ver=${iVersion}"></script>
<script type="text/javascript" src="${basePath}js/ptw/sbs/ptwButton.js?ver=${iVersion}"></script>
...
<script type="text/javascript" src="${basePath}js/ptw/sbs/ptwLic.js?ver=${iVersion}"></script>
	...
	$(document).ready(function() {
		...
		if(isNewWt){
			...
			$.post(basePath + "ptw/ptwInfo/queryBasePtwInfo.do",{id:ptwId},function(data){
				...
				isStdWt = ptwInfo.isStdWt == 1 ? true : false;				
				...
				if(!isStdWt && (ptwStatus == 500 || ptwStatus == 600 || ptwStatus == 700) ){
					initLicInfo();
				}
				initMoreInfo(data);
				initBtns();
