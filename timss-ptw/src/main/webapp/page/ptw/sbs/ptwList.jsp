...
<script>
	...
	$(document).ready(function() {
		...
		//查看工作票类型的按钮初始化
		$("#btnView").iMenu("init",{
	    	menu : [{title:"工作票",select:true,group:"groupView",selected:true,id:"wtKindMenuBtn1",onclick:"searchFromKind(0)"},
	    			 {title:"标准工作票",select:true,group:"groupView",id:"wtKindMenuBtn2",onclick:"searchFromKind(1)"}]
	    });
	...
	<div id="maincontent">
		<div class="bbox toolbar-with-pager" id="toolbar_wrap">
		    ...
		    <div id="toolbar1" class="btn-toolbar ">
				...
				<div class="btn-group btn-group-sm" id="btnView">
		    ...
		    <div id="advSearchBar" class="row bbox" style="display:none">
			    ...
			    <div id="wtStatusDiv" style="float:left;margin-left: 6px;">
			    	<select id="wtStatus" style="float:left;width:100px;margin-left: 6px;">
				    	...
				    	<option value="450">已确认安全措施</option>
