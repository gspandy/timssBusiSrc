...
<script>
	...
	var fireFields = [
	  				{id:"cfmGuardXfNo",title : "消防监护人",type:"combobox",rules : {required:true},
						options:{allowSearch:true,remoteLoadOn:"init",url:basePath+ "ptw/ptwInfo/queryPtwUsersByGroup.do?role=PTW_fire_mgr"},wrapXsWidth:5,wrapMdWidth:5},
...
<script type="text/javascript" src="${basePath}js/ptw/core/popVerifyLic.js?ver=${iVersion}"></script>
<script>
