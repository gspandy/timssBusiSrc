...
<script src='${basePath}js/ptw/zjw/updatePtwStandard.js?ver=${iVersion}'></script>
...
var eqNo = '';
//父节名字
var eqName = "<span style='color:red'>请从左边设备树选择</span>";
//隔离措施模板
...
<div class="bbox toolbar-with-pager" id="toolbar_wrap">
   <div id="toolbar" class="btn-toolbar ">
   		<div class="btn-group btn-group-sm" id="closeDiv">
            <button id="closeBtn" type="button" class="btn btn-default priv" onclick="closeTab()" privilege="PTW_STD_CLOSE">关闭</button>
        </div>
    	<div class="btn-group btn-group-sm" id="editDiv">
			<button id="saveButton" type="button" class="btn btn-default priv"  privilege="PTW_STD_SAVE">暂存</button>
			<button id="commitButton" type="button" class="btn btn-default priv" privilege="PTW_STD_COMMIT" >提交</button>
			<button id="approveBtn" type="button" class="btn btn-default priv" privilege="PTW_STD_APPR">审批</button>
		</div>
	  	<div class="btn-group btn-group-sm" id="deleteButtonDiv">
			<button id="deleteButton" type="button" class="btn btn-default priv" privilege="PTW_STD_DELETE" >删除</button>
        </div>
        <div class="btn-group btn-group-sm"  id="cancelButtonDiv">
			<button id="cancelButton" type="button" class="btn btn-default priv" privilege="PTW_STD_CANCEL" >作废</button>
        </div>
        <div class="btn-group btn-group-sm" id="modifyButtonDiv">
			<button id="modifyButton" type="button" class="btn btn-default priv" privilege="PTW_STD_MODIFY" >修改</button>
        </div>
        ...
        <div id="flowDiagramDiv" class="btn-group btn-group-sm">
        	<button id="flowDiagramBtn" type="button" class="btn btn-default priv" privilege="PTW_STD_FLOWINFO">审批信息</button>
        </div>
    </div>
</div>
	<!--这里要清掉分页器的右浮动效果-->
