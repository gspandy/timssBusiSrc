...
<script>
	...
	function initPackage(){
		...
		//电厂
		$("#parmasStation").iCombo("init",{
			data:FW.getEnumMap("WO_WIND_STATION"),
			onChange:function(){
				changeExportUrl();
			}
		});			
		...
		$("#btn_query").click(function(){
			...
			parmasStation = $("#parmasStation").iCombo("getVal");
			urlReport = fileExportPath + "preview?__report=report/TIMSS2_ZJW_PTWOSTAT_html.rptdesign"
					+ "&parmasYear="+parmasYear+"&parmasMonth="+parmasMonth+"&parmasStation="+parmasStation+"&siteid="+siteId;							
			$("#grid_error").hide();
			$("#grid_wrap").show();
	...
	function changeExportUrl(){
		...
		parmasMonth = $("#parmasMonth").iCombo("getVal");
		parmasStation = $("#parmasStation").iCombo("getVal");
		urlExport = fileExportPath + "preview?__report=report/TIMSS2_ZJW_PTWOSTAT.rptdesign&__format=pdf"
				+ "&parmasYear="+parmasYear+"&parmasMonth="+parmasMonth+"&parmasStation="+parmasStation+"&siteid="+siteId;							
		var	title = "两票统计报表";
	...
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    <div id="toolbar1" class="btn-toolbar ">
	        <div class="btn-group btn-group-sm" style="margin-left:7px;">
				...
				<span class="ctrl-label pull-left"  style="margin-left:8px">电厂：</span>
		    	<select id="parmasStation" style="width:100px;float:left">
				</select>			        
			</div>
