...
<script type="text/javascript" src="${basePath}js/ptw/zjw/ptwBase.js?ver=${iVersion}"></script>
<script type="text/javascript" src="${basePath}js/ptw/zjw/ptwButton.js?ver=${iVersion}"></script>
...
<script type="text/javascript" src="${basePath}js/ptw/zjw/ptwLic.js?ver=${iVersion}"></script>
	...
	$(document).ready(function() {
		...
		if(isNewWt){
			...
			$.post(basePath + "ptw/ptwInfo/queryBasePtwInfo.do",{id:ptwId},function(data){
				...
				joinNameAndTime(ptwInfo,"outIssuer","outIssuedTime");
				...
				//处理是否外委编辑控制
				outSourcingEdit = (ptwInfo.isOutSourcing==0 && ptwInfo.wtStatus==300)||(ptwInfo.isOutSourcing==1 && ptwInfo.wtStatus==310);
