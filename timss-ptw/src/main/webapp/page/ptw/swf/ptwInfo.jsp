...
<script type="text/javascript" src="${basePath}js/ptw/swf/ptwBase.js?ver=${iVersion}"></script>
<script type="text/javascript" src="${basePath}js/ptw/core/ptwButtonCommon.js?ver=${iVersion}"></script>
<script type="text/javascript" src="${basePath}js/ptw/swf/ptwButton.js?ver=${iVersion}"></script>
<script type="text/javascript" src="${basePath}js/ptw/core/ptwSafe.js?ver=${iVersion}"></script>
<script type="text/javascript" src="${basePath}js/ptw/swf/ptwLic.js?ver=${iVersion}"></script>
