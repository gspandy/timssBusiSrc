...
<script>
	...
	function loadPerson(key){
		...
		if(key == 'licWpicNo'){//工作负责人
			$.post(basePath+ "ptw/ptwInfo/queryPtwUsersByGroups.do",{"types":"PTW_workpic_DY,PTW_workpic_DE,PTW_workpic_RJ,PTW_workpic_JB,PTW_workpic_RY,PTW_workpic_RE", "hasOther" : "all"},function(data){
		...
		<div class="bbox toolbar-with-pager" id="toolbar_wrap">
		    ...
		    <div id="toolbar1" class="btn-toolbar ">
		        <div class="btn-group btn-group-sm">
		        	 <button type="button" class="btn btn-success" style="display:none" id="ptw_btn_new" onclick="newPtwInfo();">新建</button>
		        </div>
		    ...
		    <div id="advSearchBar" class="row bbox" style="display:none">
			    ...
			    <div id="wtStatusDiv" style="float:left;margin-left: 6px;">
			    	<select id="wtStatus" style="float:left;width:100px;margin-left: 6px;">
				    	...
				    	<option value="320">待审批</option>
				    	<option value="300">待签发</option>
		...
		<div style="height:100%;display:table;width:100%">
			<div style="display:table-cell;vertical-align:middle;text-align:center">
			    ...
			    <div class="btn-group btn-group-sm margin-element">
				    <button type="button" class="btn btn-success" id="ptw_btn_new2" style="display:none" onclick="newPtwInfo()">新建</button>
				</div>
			</div>
		</div>
	</div>
