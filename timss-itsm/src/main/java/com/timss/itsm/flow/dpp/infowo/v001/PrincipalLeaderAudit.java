...
public class PrincipalLeaderAudit extends TaskHandlerBase {
    ...
    private static final Logger LOG = Logger.getLogger( PrincipalLeaderAudit.class );

    public void init(TaskInfo taskInfo) {

        String infoWoId = workflowService.getVariable( taskInfo.getProcessInstanceId(), "businessId" ).toString();
        String woStatus = "principalLeaderAudit";
