...
public class ItcenterVerify extends TaskHandlerBase {
    ...
    private static final Logger LOG = Logger.getLogger( ItcenterVerify.class );

    public void init(TaskInfo taskInfo) {

        String infoWoId = workflowService.getVariable( taskInfo.getProcessInstanceId(), "businessId" ).toString();
        String woStatus = "itCenterVerify";
