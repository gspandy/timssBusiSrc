...
public class InitComAudit  extends TaskHandlerBase{
	...
	private static final Logger LOG = Logger.getLogger(InitComAudit.class);
  ...
  public void onComplete(TaskInfo taskInfo){
	  ...
	  String businessData = null;
		...
		//操作附件
		try {
		    itsmWoUtilService.insertAttachMatch(woId, attachmentIds, "WO", "initComAudit");
		}catch (Exception e) {
			LOG.error(e.getMessage());
			throw new RuntimeException(e);
		}
