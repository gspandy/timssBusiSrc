...
public class ApplydeptPrincipalAudit extends TaskHandlerBase {
    ...
    private static final Logger LOG = Logger.getLogger( ApplydeptPrincipalAudit.class );

    public void init(TaskInfo taskInfo) {

        String infoWoId = workflowService.getVariable( taskInfo.getProcessInstanceId(), "businessId" ).toString();
        String woStatus = "applyDeptPrincipalAudit";
