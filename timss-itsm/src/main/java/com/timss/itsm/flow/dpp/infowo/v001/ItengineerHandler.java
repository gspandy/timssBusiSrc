...
public class ItengineerHandler extends TaskHandlerBase {
    ...
    private static final Logger LOG = Logger.getLogger( ItengineerHandler.class );

    public void init(TaskInfo taskInfo) {

        String infoWoId = workflowService.getVariable( taskInfo.getProcessInstanceId(), "businessId" ).toString();
        String woStatus = "itEngineerHandler";
