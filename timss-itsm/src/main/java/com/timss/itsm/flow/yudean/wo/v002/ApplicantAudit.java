...
public class ApplicantAudit extends TaskHandlerBase {
    ...
    private static final Logger LOG = Logger.getLogger( ApplicantAudit.class );

    public void init(TaskInfo taskInfo) {

        String woId = workflowService.getVariable( taskInfo.getProcessInstanceId(), "businessId" ).toString();
        String woStatus = "applicantAudit";
    ...
    public void onComplete(TaskInfo taskInfo) {
        ...
        try {
            itsmWoUtilService.updateWoAndAttach( woId, userInfoScope, "applicantAudit" );
        } catch (Exception e) {
        ...
        String comNextAudit = businessDataobj.getString( "comNextAudit" );
        if("endWo".equals( comNextAudit )){
            // 修改工单的状态
