 ...
 * @version: 1.0
 */
public interface ItsmMaintainPlanDao {
	/**
	 * 
	 * @description： 插入
	 * @author: 王中华
	 ...
	 * @param maintainPlan:
	 */
	void insertMaintainPlan(ItsmMaintainPlan maintainPlan);
	/**
	 * 
	 * @description:更新
	 * @author: 890152
	 ...
	 * @param maintainPlan:
	 */
	void updateMaintainPlan(ItsmMaintainPlan maintainPlan);
	 ...
	 * @return:
	 */
	ItsmMaintainPlan queryITMTPById(int id);
	/**
	 ...
	 * @return:
	 */
	List<ItsmMaintainPlan> queryAllMTP(Page<ItsmMaintainPlan> page);
	/**
	 ...
	 * @return:
	 */
	List<ItsmMaintainPlan> queryAllITMTP(Page<ItsmMaintainPlan> page);
	/**
	 * @description:查询父维护计划
	 * @author: 王中华
	 ...
	 * @return:
	 */
	List<ItsmMaintainPlan> queryAllParentMTP(Page<ItsmMaintainPlan> page);
	/**
	 ...
	 * @return: 
	 */
	List<ItsmMaintainPlan> queryAllCycMTP();
	/**
