...
@Controller
@RequestMapping(value = "/itsm/jobPlan")
public class ItsmJobPlanController {
	 @Autowired
    ...
    public Page<ItsmJobPlan> JobPlanListData() throws Exception{
        UserInfoScope userInfoScope = itcMvcService.getUserInfoScopeDatas();
        String siteId = userInfoScope.getSiteId();
        Page<ItsmJobPlan> page = userInfoScope.getPage();
        
        String fuzzySearchParams = userInfoScope.getParam("search");
        Map<String, String> propertyColumnMap = MapHelper.getPropertyColumnMap( "jobPlanMap", ItsmConstant.MODULENAME,"ItsmJobPlanDao");
