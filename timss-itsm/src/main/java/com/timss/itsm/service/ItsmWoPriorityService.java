 ...
 * @version: 1.0
 */
public interface ItsmWoPriorityService {
	 ...
	 * @return:
	 */
	Page<ItsmWoPriority> queryWoPriorityList(Page<ItsmWoPriority> page);
	...
	List<ItsmWoPriority> queryWoPriorityListBySiteId(String siteid);

	ItsmWoPriority queryWoPriorityById(int priorityId);
