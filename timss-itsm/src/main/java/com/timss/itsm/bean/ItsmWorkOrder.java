...
public class ItsmWorkOrder extends ItcMvcBean{
	  
	private static final long serialVersionUID = 6597495110798227159L;
	@UUIDGen(requireType = GenerationType.REQUIRED_NULL) // 自动生成id
	private String id; 
	@AutoGen(value = "ITSM_WO_CODE" ,requireType = com.yudean.itc.annotation.AutoGen.GenerationType.REQUIRED_NULL)
	  ...
	  private String  maintType; //维护类型（非科技公司录入的）
	  ...
	  private Date  appointTime;//预约上门时间（客户）
	  
	  private Date  defaultBeginTime;//预计开始时间（工程师）
	  private Date  defaultEndTime;//预计完工时间（工程师）
	  ...
	  private int respondLen;  //响应时间长度
	  private int solveLen;   //解决时间长度
	...
	public int getRespondLen() {
		return respondLen;
	}
	public void setRespondLen(int respondLen) {
		this.respondLen = respondLen;
	}
	public int getSolveLen() {
		return solveLen;
	}
	public void setSolveLen(int solveLen) {
	...
	public String toString() {
		return "WorkOrder [id=" + id + ", workOrderCode=" + workOrderCode
				+ ", maintainPlanId=" + maintainPlanId + ", jobPlanId="
				+ jobPlanId + ", description=" + description
				+ ", workOrderTypeCode=" + workOrderTypeCode
				+ ", customerCode=" + customerCode + ", priorityId="
				+ priorityId + ", faultTypeId=" + faultTypeId
				+ ", faultTypeName=" + faultTypeName + ", appointTime="
				+ appointTime + ", beginTime=" + beginTime + ", sendWoTime="
				+ sendWoTime + ", isAdditionWO=" + isAdditionWO
				+ ", isCycleWO=" + isCycleWO + ", cycleWOId=" + cycleWOId
				+ ", fbResultType=" + fbResultType + ", isComplaint="
				+ isComplaint + ", workflowId=" + workflowId + ", currStatus="
				+ currStatus + ", equipId=" + equipId + ", sendWoNow="
				+ sendWoNow + ", partnerNames=" + partnerNames + "]";
	}
