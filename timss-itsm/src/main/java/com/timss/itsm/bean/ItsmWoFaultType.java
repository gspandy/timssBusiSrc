...
public class ItsmWoFaultType extends ItcMvcBean  {
	...
	private int id; //ID
	 // @AutoGen(value = "FAULT_TYPE",requireType = GenerationType.REQUIRED_NEW)
	  ...
	  private Integer oneLevelId;  //对应的一级目录Id
	...
	public String toString() {
		return "ItsmWoFaultType [id=" + id + ", faultTypeCode=" + faultTypeCode
				+ ", name=" + name + ", parentId=" + parentId
				+ ", parentTypeName=" + parentTypeName + ", oneLevelId="
				+ oneLevelId + ", defaultScore=" + defaultScore + ", remarks="
				+ remarks + ", keywords=" + keywords + ", principalGroup="
				+ principalGroup + ", createUser=" + createUser
				+ ", modifyUser=" + modifyUser + ", createDate=" + createDate
				+ ", modifyDate=" + modifyDate + ", yxbz=" + yxbz + "]";
	}
