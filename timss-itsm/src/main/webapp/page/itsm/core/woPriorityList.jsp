...
<script>
	...
	$(document).ready(function() {
		...
		dataGrid = $("#woPriority_table").iDatagrid("init",{
	        ...
	        url: basePath + "itsm/woParamsConf/woPriorityListData.do",	     
	        singleSelect:true,
	        columns:[[
	...
	function openWoPriorityInfo(rowData){
	   ...
	   var opts = {
	        id : "openWoType"+rand,
	        name : "服务级别详情",
	        url : basePath+ "itsm/woParamsConf/openWoPriorityPage.do?woPriorityId="+woPriorityId,
	        tabOpt : {
	        	closeable : true,
	...
	function newWoPriority(){
	 //新建一个与时间相关的随机数 防止多次点击新建选项卡时ID重复
	   ...
	   var opts = {
	        id : "newWoType"+rand,
	        name : "新建服务级别",
	        url : basePath+ "itsm/woParamsConf/openWoPriorityPage.do",
	        tabOpt : {
	        	closeable : true,
	        	afterClose : "FW.deleteTab('$arg'); FW.activeTabById('itsm_root');FW.getFrame('itsm_root').refresh();"
	        }
