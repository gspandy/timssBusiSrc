...
<script>
	...
	$(document).ready(function(){
		...
		$("#selectTimeForm").iForm("setVal",{"beginTime":beginTime,"endTime":endTime})
 		...
 		dataGrid = $("#woItPersonStatistic_table").iDatagrid("init",{
	        ...
	        singleSelect:true,
	        columns:[[ 
					{field:"serLevel",title:"姓名",width:100,align:'center',fixed:true,
	...
	function printStatisticList(){
		...
		var src = fileExportPath + "preview?__report=report/TIMSS2_ITSM_ITPERSON_KPI.rptdesign&__format=pdf"+
