...
<script>
	...
	$(document).ready(function() {
		 ...
		 dataGrid = $("#jobPlan_table").iDatagrid("init",{
	        ...
	        singleSelect:true,
	        columns:[[ 
					{field:"jobPlanCode",title:"编号",width:150,fixed:true,sortable:true}, 
	...
	function openJobPlanInfo(rowData){
	   ...
	   var opts = {
	        id : "openItsm"+rand,
	        name : "作业方案详情",
	        url : basePath+ "itsm/jobPlan/queryFullJPPage.do?jobPlanId="+jobPlanId,
	        tabOpt : {
	        	closeable : true,
	...
	function newJobPlan(){
	 //新建一个与时间相关的随机数 防止多次点击新建选项卡时ID重复
	   ...
	   var urlPath = basePath+ "itsm/jobPlan/openNewJPPage.do?faultTypeParams="+encodeURIComponent(faultTypeParams);
	   var opts = {
	        id : "newItsmJP"+rand,
	        name : "新建标准作业方案",
	        url : urlPath,
