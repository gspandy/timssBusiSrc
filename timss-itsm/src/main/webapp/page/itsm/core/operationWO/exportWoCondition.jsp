	...
	var fields = [
			    ...
			    {title : "结束时间", id : "toTime",type:"date", dataType:"date",
				 ...
				 {title : "用户组", id : "rysx", type : "combobox",
				 	options : {
				 		allowEmpty:true,
					 	url : basePath + "itsm/woUtil/userGroupFilter.do?filterStr=itc_itsm_wt",
			    		multiselect:true,
			    	    remoteLoadOn : "init",
			    	    onChange:function(val,obj){ 
			    	    	if(val==""){
			    	    		...
			    	    		$.post(basePath + "itsm/woUtil/userGroupGetUserIds.do",{"userGroupIds":val},
										function(data){
											var result = {}; 
			    ...
			    {title : "工程师", id : "engineers", type : "combobox", 
			    	options : {
			    		allowSearch:true,
			    		allowEmpty:true,
			    		url : basePath + "itsm/woUtil/engineerRole.do",
			    		multiselect:true,
			    	    remoteLoadOn : "init"
			    	}	
			    },
			    ...
			    {title : "服务目录", id : "serDirectorys",
			    	render:function(id){
		            	 ...
		            	 ipt.next(".itcui_input_icon").on("click",function(){
		                     var src = basePath+"page/itsm/core/woParamsConf/sampleSerDirectoryTree.jsp?embbed=1";
