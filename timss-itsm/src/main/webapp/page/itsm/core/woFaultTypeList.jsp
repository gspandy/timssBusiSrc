...
<script>
	...
	$(document).ready(function() {
		...
		dataGrid = $("#faultType_table").iDatagrid("init",{
	        ...
	        url: basePath + "itsm/itsmFaultType/faultTypeListData.do",	     
	        singleSelect:true,
	        columns:[[ 
					{field:"faultTypeCode",title:"编码",width:100,fixed:true,sortable:true}, 
					{field:"name",title:"名字",width:150,fixed:true}, 
					{field:"defaultScore",title:"排序码",width:200,sortable:true},
	...
	function openFaultTypeInfo(rowData){
	   ...
	   var opts = {
	        id : "openItsmFaultType"+rand,
	        name : "服务目录详情",
	        url : basePath+ "itsm/itsmFaultType/openFaultTypePage.do?ftRootId="+ftRootId+"&faultTypeId="+faultTypeId,
	        tabOpt : {
	        	closeable : true,
	...
	function newFaultType(){
	   ...
	   var opts = {
	        id : "newItsmFaultType"+rand,
	        name : "新建服务目录",
	        url : basePath+ "itsm/itsmFaultType/openFaultTypePage.do?ftRootId="+ftRootId+"&selectFTypeId="+
