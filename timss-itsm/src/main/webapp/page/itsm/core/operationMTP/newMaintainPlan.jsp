...
<html>
  <head>
	...
	<script type="text/javascript" src="${basePath}js/itsm/core/newMaintainPlan.js?ver=${iVersion}"></script>
  ...
  <body style="height: 100%;">
	...
	<div  class="inner-title">
			<span id="inPageTitle">维护计划详情</span>
	</div>
    <div>
