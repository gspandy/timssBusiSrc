...
<script>
	...
	$(document).ready(function() {
		...
		dataGrid = $("#woLabel_table").iDatagrid("init",{
	        ...
	        url: basePath + "itsm/woParamsConf/woLabelListData.do",	     
	        singleSelect:true,
	        columns:[[ 
	...
	var woLabelId = rowData.id;
	   ...
	   var opts = {
	        id : "openWoLabel"+rand,
	        name : "工单标识详情",
	        url : basePath+ "itsm/woParamsConf/openWoLabelPage.do?woLabelId="+woLabelId,
	        tabOpt : {
	        	closeable : true,
	...
	function newWoLabel(){
	 //新建一个与时间相关的随机数 防止多次点击新建选项卡时ID重复
	   ...
	   var opts = {
	        id : "newWoLabel"+rand,
	        name : "新建标识",
	        url : basePath+ "itsm/woParamsConf/openWoLabelPage.do",
	        tabOpt : {
	        	closeable : true,
	        	afterClose : "FW.deleteTab('$arg'); FW.activeTabById('itsm_root');FW.getFrame('itsm_root').refresh();"
	        }
