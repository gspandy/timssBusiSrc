...
public class EipBranchFlowProcessUtil {
        ...
        if ( elementMap != null ) {
            ...
            if ( StringUtils.isNotBlank( modifiable ) ) {
                ...
                try {
                    ...
                    throw new Exception( "流程定义id为" + processId + ",taskDefKey为" + taskDefKey + "的流程配置modifiable有错误", e );
                }
                // 设置流程变量
     ...
     * @return
     */
    public List<RetTask> getNextElementsByFlowProperty(String processId, Task currentTask) throws Exception {
    ...
    // 为分支节点获取所以可能的下一节点
    private void getAllNextElementForBranch(Map<String, Object> modifiableMaps, String processId, List<RetTask> rtList,
