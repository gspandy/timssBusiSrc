...
<script>
	...
	function refCurPage(){
	 	$("#accept_grid").datagrid("reload");
	}
</script>
<script src="${basePath}js/inventory/core/invmataccept/invAcceptBtn.js?ver=${iVersion}"></script>
<script src="${basePath}js/inventory/core/invmataccept/invAcceptList.js?ver=${iVersion}"></script>
<script src="${basePath}js/inventory/core/invmataccept/invAcceptProc.js?ver=${iVersion}"></script>
</head>
	...
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    ...
	    <div id="toolbar1" class="btn-toolbar ">
	        <div class="btn-group btn-group-sm">
	        	<button type="button" id="btn_new" data-toggle="button" class="btn btn-success priv" privilege="acceptList_new">新建</button>
	        </div>
	        <div class="btn-group btn-group-sm">
