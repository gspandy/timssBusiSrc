	    ...
	    <table id="invmatapply_grid" pager="#pagination" class="eu-datagrid">
	    	<thead>
				<tr>
					...
					<th data-options="field:'applyType',width:110,fixed:true,sortable:true">类型</th>
					<th data-options="field:'createuser',width:70,fixed:true">申请人</th>
					<th data-options="field:'dept',width:90,fixed:true">申请部门</th>
					<th data-options="field:'createdate',width:110,fixed:true,sortable:true,formatter: function(value,row,index){return FW.long2date(value);}">申请日期</th>
					<th data-options="field:'price',width:70,fixed:true,sortable:true,align:'right'">成本(元)</th>
