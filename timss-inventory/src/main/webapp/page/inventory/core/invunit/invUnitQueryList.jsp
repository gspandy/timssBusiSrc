...
<script>
	...
	$(document).ready(function() {
		...
		$("#unit_grid").iDatagrid("init",{
			...
			onLoadSuccess:function(data){
				...
				setTimeout(function(){ $("#unit_grid").datagrid("resize"); },200);
			}
		});
	});
	...
	function getUnit(){
		var info = "";
		var rowData = $("#unit_grid").datagrid("getSelected");
		if( rowData == null || rowData == "" ){
			FW.error("请选择计量单位信息 ");
			return;
		}else{
			info = rowData.unitid+"||"+rowData.unitname;
		}
		return info;
	}
</script>
...
<body style="height: 100%;" class="bbox list-page">
	...
	<div id="grid1_wrap" style="width:100%">
	    <table id="unit_grid" pager="#pagination" class="eu-datagrid">
	    	<thead>
				<tr>
					<th data-options="field:'ck',width:10,checkbox:'true',fixed:true"></th>
					<th data-options="field:'unitid',width:90,sortable:true,fixed:true">单位编码</th>
					<th data-options="field:'unitname',width:200,sortable:true,fixed:true">单位名称</th>
					<th data-options="field:'descriptions',width:200">单位描述</th>
				</tr>
			</thead>
	    </table>
	</div>
