...
<script>
	...
	var new_form = [
		    ...
		    {title : "专业", id : "attr2", rules : {required:true}, options:{allowEmpty:true},
	    		type : "combobox",
	...
	$(document).ready(function() {
		...
		if("" == itemId){
			...
			//当生物质站点用户登录时才做这个权限控制
			Priv.map("privMapping.itemList_save","itemList_save");
			Priv.apply();					
		}
		initList();
	});
	...
	<div class="bbox toolbar-with-pager" id="toolbar_wrap">
	    ...
	    <div id="toolbar" class="btn-toolbar ">
	    	<div class="btn-group btn-group-sm">
	        	<button type="button" id="btn_close" class="btn btn-default">返回</button>
	        </div>
