...
<% 
	...
	String purApplyId = request.getAttribute("purApplyId")==null?"":String.valueOf(request.getAttribute("purApplyId"));
%>
...
<script>
	...
	var oper = '<%=oper%>';
	var hasRpts = '<%=hasRpts%>';
	var purApplyId = '${purApplyId}';    //从采购申请处获取
...
<script src="${basePath}js/inventory/swf/invmatapply/invMatApplyForm.js?ver=${iVersion}"></script>
<script src="${basePath}js/inventory/swf/invmatapply/invMatApplyList.js?ver=${iVersion}"></script>
...
<body>
	...
	<div id="matapplydetail_list" grouptitle="物资明细">
		...
		<div class="btn-toolbar margin-foldable-button" role="toolbar">
		    ...
		    <div class="btn-group btn-group-xs">
		        <button type="button" class="btn btn-success" id="btn_addFromPA">根据采购申请添加</button>
		    </div>
		</div>
	</div>
