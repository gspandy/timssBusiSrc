...
<script src="${basePath}js/inventory/sjw/invmatrecipients/invMatRecipientsForm.js?ver=${iVersion}"></script>
<script src="${basePath}js/inventory/sjw/invmatrecipients/invMatRecipientsList.js?ver=${iVersion}"></script>
