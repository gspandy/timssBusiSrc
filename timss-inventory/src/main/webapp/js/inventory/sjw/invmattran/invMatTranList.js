var grid=[[
		...
		{title:'货柜',field:'bin',width:70,fixed:true,hidden:true},
		...
		{title:'含税单价',field:'price',width:75,fixed:true,
			formatter:function(value){
				return parseFloat(value).toFixed(4);
			}
		},
		{title:'含税金额',field:'taxAmount',width:75,fixed:true,
			formatter:function(value){
				return parseFloat(value).toFixed(2);
			}	
		},
		{title:'不含税单价',field:'noTaxPrice',width:75,fixed:true,
			formatter:function(value){
				return parseFloat(value).toFixed(4);
			}	
		},
		{title:'不含税金额',field:'noTaxAmount',width:75,fixed:true,
			formatter:function(value){
				return parseFloat(value).toFixed(2);
			}	
		},
