var InvAcceptForm={
	...
	basicFormField : [
    	    ...
    	    {title : "是否特殊物资", id : "specialMaterials", rules : {required:true},
    	    	type:"combobox",
    	    	dataType:'enum',
    		    enumCat:'ACPT_SPECIAL_MATERIALS',
    		    options:{
    		    	multiselect:false
    		    }
    	    },
    	    {title: "即收即发", id : "autoDelivery", type:"label",
    ...
    acceptFormField : [
		    ...
		    {id:"inacNo",title:"编号"},
		    {id:"poName",type:"hidden"},
		    {title : "是否特殊物资", id : "specialMaterials",
    	    	type:"combobox",
    	    	dataType:'enum',
    		    enumCat:'ACPT_SPECIAL_MATERIALS'
    	    },
    	    ...
    	    {title : "处理结果", id : "procRult", rules : {required:true},
    	    	type:"combobox",
    	    	dataType:'enum',
    		    enumCat:'ACPT_PROC_RULT',
    		    options:{
    		    	allowEmpty:true
    		    }
    	    },
    	    {title : "存在问题", id : "problems", rules : {required:true},
    	    	type:"combobox",
    	    	dataType:'enum',
    		    enumCat:'ACPT_PROBLEMS',
    		    options:{
    		    	multiselect:true
    		    }
    	    },
    ...
    initFormForAdd:function(form,data){
    	if(data.poId){
    		...
    		form.iForm('endEdit',["poSheetno","createdate","createusername","autoDelivery"]);
    	}else{
    		var formData={
        			createdate:new Date(),
        			createusername:data.createusername
    		...
    		form.iForm('setVal',formData);
    		form.iForm('endEdit',["createdate","createusername","autoDelivery"]);
    	}
    },
