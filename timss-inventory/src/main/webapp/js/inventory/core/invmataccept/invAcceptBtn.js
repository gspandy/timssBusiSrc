var InvAcceptBtn={
	...
	initPrint:function(data){
		...
		var url= fileExportPath+"preview?__format=pdf&__report=report/TIMSS_INV_SWF_ACCEPT_001.rptdesign&id="+data.inacId+"&proc_inst_id="+processId;
	...
	approveEvent:function(data){
		...
		$.post(
			basePath+'inventory/invmataccept/setVariable.do',
			{
				processId:processInstId,
				sp_mate:formData.specialMaterials || "",
				proc_result:formData.procRult || ""
			},function(result){
