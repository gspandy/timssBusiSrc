var grid=[[
		...
		{title:'物资编号',field:'itemcode',width:70,fixed:true,formatter:function(value,row){
		...
		{title:'采购合同号',field:'purorderno',width:110,fixed:true},
		{title:'项目名称',field:'projectAscription',width:110,fixed:true},
		{title:'仓库id',field:'warehouseid',hidden:true},
		{title:'仓库',field:'warehouse',width:100,fixed:true},
		{title:'货柜id',field:'binid',hidden:true},
		{title:'货柜',field:'bin',width:90,fixed:true},
		...
		{title:'单价(元)',field:'price',width:70,align:'right',fixed:true},
		{title:'总价(元)',field:'totalprice',width:70,align:'right',fixed:true,
			formatter:function(value,row){
	   			return parseFloat(row.batchstockqty*row.price).toFixed(2);
	   		}	
		},
...
var returnGrid=[[
   		...
   		{title:'物资名称',field:'itemname',width:90},
   		{title:'物资型号',field:'cusmodel',width:70},
   		{title:'退货单号',field:'imrsno',width:220,fixed:true},
  		{title:'仓库id',field:'warehouseid',hidden:true},
   		{title:'仓库',field:'warehouse',width:100,fixed:true},
   		{title:'货柜id',field:'binid',hidden:true},
   		{title:'货柜',field:'bin',width:90,fixed:true},
   		{title:'退货原因',field:'imrsreason',width:260,fixed:true},
   		{title:'退货数量',field:'returnQty',width:70,align:'right',fixed:true},
   		{title:'单位',field:'unitname',width:70,fixed:true},
   		{title:'单位id',field:'unit1',hidden:true},
...
function checkReturnable(){
	...
	if(listTranData.length > listReturnData.length){
		return true;
	}
